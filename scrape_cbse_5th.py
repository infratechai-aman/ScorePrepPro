...
SUBJECTS = [
    {
        ...
        "grade": "5",
        "subject": "Mathematics",
        "list_url": "https://www.shaalaa.com/search-concept-notes/cbse-class-5-english-medium_1476?subjects=mathematics_9020",
        "chapters": [
...
def main():
    print("=" * 60)
    print("SHAALAA.COM CBSE 5TH STD CONTENT SCRAPER")
    print("=" * 60)
    ...
    generate_typescript()
    print("\\nDONE! TypeScript generated with CBSE 5th, 6th, 7th, 8th, 9th, 10th and SSC files.")
