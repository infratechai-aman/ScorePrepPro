...
SUBJECTS = [
    {
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/cbse-class-10-secondary-school-examination-english-medium_660?subjects=social-science_3149",
        "chapters": [
            ...
            "Development", "Sectors of the Indian Economy", "Money and Credit", "Globalization and the Indian Economy"
        ]
    }
]
...
def main():
    print("=" * 60)
    print("SHAALAA.COM CBSE 10TH STD CONTENT SCRAPER")
    print("=" * 60)
    ...
    generate_typescript()
    print("\\nDONE! TypeScript generated with CBSE and SSC files.")
