...
SUBJECTS = [
    {
        ...
        "grade": "7",
        "subject": "Mathematics",
        "list_url": "https://www.shaalaa.com/search-concept-notes/cbse-class-7-english-medium_1442?subjects=mathematics_8486",
        "chapters": [
    ...
    },
    {
        ...
        "grade": "7",
        "subject": "Science",
        "list_url": "https://www.shaalaa.com/search-concept-notes/cbse-class-7-english-medium_1442?subjects=science_8487",
        "chapters": [
    ...
    },
    {
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/cbse-class-7-english-medium_1442?subjects=social-science_8906",
        "chapters": [
            "Tracing Changes Through a Thousand Years", "New Kings and Kingdoms", "The Delhi Sultans", 
            "The Mughal Empire", "Tribes, Nomads and Settled Communities", "Devotional Paths to the Divine", 
    ...
    },
    {
        ...
        "chapters": [
            ...
            "Human Environment Interactions - The Tropical and the Subtropical Region", "Life in the Deserts"
        ]
    },
    {
        "board": "cbse",
...
def main():
    print("=" * 60)
    print("SHAALAA.COM CBSE 7TH STD CONTENT SCRAPER")
    print("=" * 60)
    ...
    generate_typescript()
    print("\\nDONE! TypeScript generated with CBSE 7th, 8th, 9th, 10th and SSC files.")
