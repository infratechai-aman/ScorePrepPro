...
SUBJECTS = [
    {
        ...
        "grade": "8",
        "subject": "Mathematics",
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-8th-standard-secondary-school-certificate-english-medium_1461?subjects=mathematics_8882",
        "chapters": [
            "Rational and Irrational Numbers", "Parallel Lines and Transversals",
            "Indices and Cube Root", "Altitudes and Medians of a Triangle",
            "Expansion Formulae", "Factorisation of Algebraic Expressions",
            "Variation", "Quadrilateral: Constructions and Types",
            "Discount and Commission", "Division of Polynomials", "Statistics",
            "Equations in One Variable", "Congruence of Triangles",
            "Compound Interest", "Area", "Surface Area and Volume",
            "Circle: Arc and Chord"
        ]
    },
    {
        "board": "maharashtra",
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-8th-standard-secondary-school-certificate-english-medium_1461?subjects=general-science-class-8_8881",
        "chapters": [
            "Living World and Classification of Microbes", "Health and Diseases",
            "Force and Pressure", "Current Electricity and Magnetism",
            "Inside the Atom", "Composition of Matter", "Combustion, Flame and Fuel",
            "Pollution", "Disaster Management", "Cell and Cell Organelles",
            "Human Body and Organ System", "Introduction to Acid and Base",
            "Chemical Change and Chemical Bond", "Measurement and Effects of Heat",
    ...
    },
    {
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-8th-standard-secondary-school-certificate-english-medium_1461?subjects=history-civics_8883",
        "chapters": [
            "Sources of Cultural History", "Arts and Literature During Medieval Period",
            "India and the Modern World", "The French Revolution", "The Industrial Revolution",
            "Urbanisation", "The First War of Indian Independence", "Struggle for Equality",
            "Indian Constitution – Formation and Concepts", "Fundamental Rights and Duties",
            "Directive Principles", "The Indian Judiciary"
        ]
    },
    {
        "board": "maharashtra",
        "grade": "8",
        "subject": "Geography",
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-8th-standard-secondary-school-certificate-english-medium_1461?subjects=geography_8884",
        "chapters": [
            "Local Time and Standard Time", "Rotation and Revolution of the Earth",
            "Pressure Belts and Types of Winds", "Volcanoes and Earthquakes",
            "Rocks and Rock Types", "Internal Processes of the Earth", "Weather and Climate",
            "India: Introduction, Physical Divisions", "Agriculture in India",
            "Industries in India", "Transport and Communication"
        ]
    }
]
...
def main():
    print("=" * 60)
    print("SHAALAA.COM 8TH STD CONTENT SCRAPER")
    print("=" * 60)
    ...
    generate_typescript()
    print("\\nDONE! TypeScript generated with 8th, 9th and 10th standard files.")
