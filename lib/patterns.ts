    ...
    maharashtra: {
        class10: {
            ...
            "History and Political Science": {
                totalMarks: 40,
                structure: [
                    { section: "Q.1 (A)", type: "Choose Correct Option", marskPerQuestion: 1, count: 4 },
                    { section: "Q.1 (B)", type: "Identify Wrong Pair", marskPerQuestion: 1, count: 4 },
                    ...
                    { section: "Contains Political Science", type: "MCQ/True-False/Concept", marskPerQuestion: 0, count: 0, note: "Separated in paper but part of 40 marks" }
                ]
            },
            "Geography": {
                totalMarks: 40,
        ...
        class9: {
            ...
            "Geography": {
                ...
                structure: [
                    ...
                    { section: "Q.2", type: "Match the Following", marskPerQuestion: 1, count: 4 },
                    { section: "Q.3", type: "One Sentence Answer", marskPerQuestion: 1, count: 4, choice: "Any 4 from 5" },
                    { section: "Q.4", type: "Map Based", marskPerQuestion: 4, count: 2 },
                    { section: "Q.5", type: "Geographical Reasons", marskPerQuestion: 3, count: 2, choice: "Any 2 from 4" },
                    { section: "Q.6", type: "Graph/Map Reading", marskPerQuestion: 3, count: 2 },
                    { section: "Q.7", type: "Detailed Answer", marskPerQuestion: 4, count: 2, choice: "Any 2 from 3" }
                ]
            }
        }
