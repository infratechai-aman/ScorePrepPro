...
SUBJECTS = [
    {
        ...
        "grade": "5",
        "subject": "Mathematics",
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-5th-standard-secondary-school-certificate-english-medium_1465?subjects=mathematics_8913",
        "chapters": [
            "Roman Numerals", "Number Work", "Addition and Subtraction",
            "Multiplication and Division", "Fractions", "Angles", "Circles",
            "Multiples and Factors", "Decimal Fractions", "Measuring Time",
            "Problems on Measurement", "Perimeter and Area", "Three Dimensional Objects and Nets",
            "Pictographs", "Patterns", "Preparation for Algebra"
        ]
    },
    {
        "board": "maharashtra",
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-5th-standard-secondary-school-certificate-english-medium_1465?subjects=environmental-studies-1_8917",
        "chapters": [
            "Our Earth and Our Solar System", "Motions of the Earth", "The Earth and its Living World",
            "Environmental Balance", "Family Values", "Rules Are for Everyone",
            "Let us Solve our own Problems", "Public Facilities and my School",
            "Maps – our Companions", "Getting to Know India", "Our Home and Environment",
            "Food for All", "Methods of Preserving Food", "Transport", "Communication and Mass Media",
            "Water", "Clothes - our Necessity", "The Environment and Us", "Constituents of Food",
            "Our Emotional World", "Busy at Work – our Internal Organs", "Growth and Personality Development",
            "Infectious Diseases and how to Prevent them", "Substances, Objects and Energy",
    ...
    },
    {
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-5th-standard-secondary-school-certificate-english-medium_1465?subjects=environmental-studies-2_8918",
        "chapters": [
            "What is History?", "History and the Concept of Time", "Life on Earth", "Evolution",
            "Evolution of Mankind", "Stone Age: Stone Tools", "From Shelters to Village-settlements",
            "Beginning of Settled Life", "Settled Life and Urban Civilization", "Historic Period"
        ]
    }
]
...
def main():
    print("=" * 60)
    print("SHAALAA.COM 5TH STD CONTENT SCRAPER")
    print("=" * 60)
    ...
    generate_typescript()
    print("\\nDONE! TypeScript generated with 5th, 6th, 7th, 8th, 9th and 10th standard files.")
