...
SUBJECTS = [
    {
        ...
        "grade": "7",
        "subject": "Mathematics",
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-7th-standard-secondary-school-certificate-english-medium_1467?subjects=mathematics_8901",
        "chapters": [
            "Geometrical Constructions", "Multiplication and Division of Integers",
            "HCF and LCM", "Angles and Pairs of Angles", "Operations on Rational Numbers",
            "Indices", "Joint Bar Graph", "Algebraic Expressions and Operations",
            "Equations in One Variable", "Properties of Triangles", "Circle",
            "Perimeter and Area", "Pythagoras' Theorem", "Symmetry"
        ]
    },
    {
        "board": "maharashtra",
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-7th-standard-secondary-school-certificate-english-medium_1467?subjects=general-science_8904",
        "chapters": [
            "Plants – Structure and Function", "Plants – Growth", "Properties of Natural Resources",
            "Nutrition in Living Organisms", "Food Safety", "Measurement of Physical Quantities",
            "Motion, Force and Work", "Static Electricity", "Heat", "Acids, Bases and Salts",
            "Classification of Organisms", "The Universe", "Sound", "Properties of Lenses"
        ]
    },
    {
        "board": "maharashtra",
        ...
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-7th-standard-secondary-school-certificate-english-medium_1467?subjects=history-and-civics_8926",
        "chapters": [
            "Sources of History", "India before the Times of Shivaji Maharaj",
            "Features of the Constitution (contd.)", "Fundamental Rights Part I & II",
            "Directive Principles", "Expansion of the Maratha Power", "The Marathas and the Mughals",
            "The Advent of Europeans in India", "British Expansion in India",
            "Administration, Revenue and Judicial Systems"
        ]
    },
    {
        "board": "maharashtra",
        "grade": "7",
        "subject": "Geography",
        "list_url": "https://www.shaalaa.com/search-concept-notes/maharashtra-board-7th-standard-secondary-school-certificate-english-medium_1467?subjects=geography_8925",
        "chapters": [
            "Tools for Study of Geography", "India: Location and Extent", "India: Physical Divisions",
            "India: Climate", "India: Natural Vegetation", "India: Water Resources",
            "India: Agriculture", "Population"
        ]
    }
]
...
def main():
    print("=" * 60)
    print("SHAALAA.COM 7TH STD CONTENT SCRAPER")
    print("=" * 60)
    ...
    generate_typescript()
    print("\\nDONE! TypeScript generated with 7th, 8th, 9th and 10th standard files.")
